 ...
 */
function injectRecordButton(commentBox) {
            ...
            if (!recording) {
                ...
                if (recordedBlob && recordedBlob.size > 0) {
                    ...
                    try {
                        ...
                        const textarea = commentBox.querySelector('textarea[name="comment[body]"]');
                        if (textarea) {
...
function initialize() {
    ...
    const injectAllButtons = () => {
        const textareas = document.querySelectorAll('textarea[name="comment[body]"]');
